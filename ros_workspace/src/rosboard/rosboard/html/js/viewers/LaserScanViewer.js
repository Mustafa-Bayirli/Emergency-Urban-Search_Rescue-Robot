...
class LaserScanViewer extends Space2DViewer {
  ...
  onData(msg) {
    ...
    let drawObjects = ([
      //{type: "path", data: [0, 0, 1, 0], color: "#00f060", lineWidth: 2}, // unit x axis visualization in red
      //{type: "path", data: [0, 0, 0, 1], color: "#f06060", lineWidth: 2}, // unit y axis visualization in green
      {type: "points", data: points, color: "#ff0000"}, // the laserscan points to be plotted
    ]);
